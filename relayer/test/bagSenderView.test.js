...
// Задача 1 внутреннего плана «Клиент чата» (не публикуется): GET /bags теперь
// отдаёт {inbox, sent, peers} вместо голого массива. Решение координатора при
// сверке плана — тот же самый опрос, что и раньше (раз в 5с), несёт теперь и
// то, что нужно отправителю про его исходящие ("забрали ли"), и список
// собеседников с их последним появлением — вместо отдельного запроса на каждое.
//
