...
// `docs/superpowers/specs/2026-08-02-e2e-chat-design.md` §4). Привязку силой
// навязывают только пароли-ключи (WebAuthn с постоянным секретом), и у них своя
// цена: ключ не выводится из кошелька, а восстановление истории на новом
// устройстве идёт через синхронизацию или код. Это отдельный замысел.
//
