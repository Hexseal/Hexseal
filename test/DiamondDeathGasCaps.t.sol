...
contract DiamondDeathGasCapsTest is DiamondDeathEscrowBase {
    ...
    // the assertion could never fail. (docs/PROCESS.md, the fourth way.)
    //
    ...
    //
    // WHERE THE BUDGETS COME FROM. They are hand-copied from
    // frontend/src/lib/relay.ts, GAS_DEFAULTS -- the ceilings that table
    ...
    /// Site 1 of 7 — Agreement.sol:732, release().
    ...
    /// Site 2 of 7 — Agreement.sol:748, triggerAutoApprove().
    ...
    /// Site 3 of 7 — Agreement.sol:908, resolveDispute(), reached the way the
    ...
    /// Site 4 of 7 — Agreement.sol:926, triggerActivationTimeout().
    ...
    /// Site 5 of 7 — Agreement.sol:950, triggerDeadlineTimeout().
    ...
    /// Site 6 of 7 — Agreement.sol:1036, triggerArbiterTimeout(), the branch
    ...
    /// Site 7 of 7 — Agreement.sol:1071, triggerArbiterTimeout(), the branch
