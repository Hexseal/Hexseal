...
// Единый guard для всех фасетов — предотвращает кросс-фасетный reentrancy.
...
// ---------- DIAMOND CUT FACET ----------
// Это встроенный фасет — управление самим Diamond
...
// ---------- DIAMOND LOUPE FACET ----------
// Читалка — какие фасеты есть, какие селекторы
