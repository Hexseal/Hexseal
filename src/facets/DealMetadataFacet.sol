...
//
// Agreement.sol вызывает getDealTokenURI() через Diamond.
// Это позволяет держать Agreement.sol маленьким (FactoryFacet
// вшивает весь Agreement bytecode при деплое через new()).
//
