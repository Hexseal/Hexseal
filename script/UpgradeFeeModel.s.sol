...
// См. docs/superpowers/specs/2026-07-28-fee-economics-design.md и
...
// скрипт его сознательно не делает (см. отчёт
// docs/superpowers/reports/2026-07-30-upgrade-script.md, решение не должно
// приниматься молча):
