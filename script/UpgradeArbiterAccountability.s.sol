 ...
 *             только после сноса), положение арбитра.
 ...
 * фразе протухает быстрее числа, поэтому его тут больше нет. Поэтому
...
contract UpgradeArbiterAccountability is Script {
    ...
    function addAccountabilitySelectors() public pure returns (bytes4[] memory sels) {
        ...
        // Задача 8: право ответа обвинённого (с 19 августа 2026 — и во время
        // паузы, не только после сноса)
