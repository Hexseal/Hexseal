 ...
 * владельца от 17 августа: ответ снятого показывается НАРАВНЕ с обвинением.
...
/** Ответ снятого арбитра на обвинение. */
export interface RemovalAnswer {
  /** Отпечаток ответа из цепи. `null` — не отвечал (или не снимали). */
  digest: Hex | null;
  /**
