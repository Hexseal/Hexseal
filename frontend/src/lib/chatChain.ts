 ...
 *  без якоря функция честно скажет broken. `bad_anchor` — это НЕ
 *  заключение о цепочке, а отказ судить о ней из-за мусора в опциях
 *  проверки. Перед любыми выводами о самой цепочке (в частности — прежде
 *  чем предъявить bad_anchor как «сторона предъявила подделку») нужно
 *  перезвать verifyChain(links) без опций и разбирать уже тот вердикт. */
