...
export const CONTRACTS = {
  diamond:    (process.env.NEXT_PUBLIC_DIAMOND_ADDRESS     || '0xF00CC71878c226E0b64253Fb71dD802aF12165D0') as `0x${string}`,
...
export const JOB_RECEIPT_FACET_ABI = [
  ...
  // ─── OfferNFTFacet — business functions ──────────────────────────────────
  {
    inputs: [
      { internalType: 'string',  name: 'title',       type: 'string'  },
  ...
  },
  {
    ...
    name: 'hireAndCreateDeal',
    outputs: [{ internalType: 'address', name: 'agreement', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'hireAndCreateDealWithPermit',
    outputs: [{ internalType: 'address', name: 'agreement', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
    ...
    outputs: [
      {
        ...
        internalType: 'struct OfferNFTStorage.Offer',
        name: '',
        type: 'tuple',
      },
    ],
